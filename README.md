...
- [Настройка эмуляции](#-настройка-эмуляции)
- [Запуск в Renode](#-запуск-в-renode)
...
### 3. Установите Renode
- Скачайте с [официального сайта](https://renode.io/)
...
1. Откройте панель PlatformIO (иконка 🏠 слева)
2. Нажмите **PIO Home** → **New Project**
...
pio project init --board bluepill_f103c8 --framework stm32cub
```
